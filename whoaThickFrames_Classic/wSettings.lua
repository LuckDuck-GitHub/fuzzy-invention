...
function whoa:Init(event, addon, ...)
	if (event == "ADDON_LOADED" and addon == "whoaThickFrames_Classic") then
		...
		if lortiUIaddon then
			print("|cff00ccff[whoa ThickFrames]:|cffffff00 Lorti-UI-Classic detected. |cffffffffMake sure to enable whoa´s dark frames with /wtf to match with LortiUI.");
		end
		print("|cff00ccff[whoa ThickFrames] v1.4|cffffffffis now |cff00ff00loaded. |cffffffffUse |cffffff00'/whoa' |cffffffffview options.")
