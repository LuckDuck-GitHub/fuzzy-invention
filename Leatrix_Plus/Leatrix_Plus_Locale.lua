...
L["If checked, cooldown icons will be shown above the player frame.|n|nIf unchecked, cooldown icons will be shown above the target frame."] = "勾选后，冷却图标显示于玩家框体上方。|n|n如果未勾选，则显示在目标框体上方。"
...
L["If checked, you will be able to pan (right-button) and zoom (mousewheel) in the character frame, dressup frame and inspect frame.  You will be able to middle-click the character model in the character frame to toggle character attributes.  Model rotation controls will be hidden.  Buttons to toggle gear will be added to the dressup frame."] = "Si está seleccionado, podrá desplazarse (botón derecho) y hacer zoom (rueda del ratón) en el marco del personaje, el marco del probador y el marco de inspección. Podrás hacer clic con el botón central en el modelo del personaje en el marco del personaje para alternar los atributos del personaje. Los controles de rotación del modelo estarán ocultos. Los botones para alternar el equipo se agregarán al marco del probador."
...
L["If checked, you will be able to pan (right-button) and zoom (mousewheel) in the character frame, dressup frame and inspect frame.  You will be able to middle-click the character model in the character frame to toggle character attributes.  Model rotation controls will be hidden.  Buttons to toggle gear will be added to the dressup frame."] = "Si cette option est cochée, vous pourrez effectuer un panoramique (bouton droit) et un zoom (molette de la souris) dans le cadre du personnage, le cadre de la cabine d'essayage et d'inspection. Vous pourrez cliquer avec le bouton central sur le modèle de personnage dans le cadre du personnage pour basculer les attributs du personnage. Les commandes de rotation du modèle seront masquées. Des boutons pour basculer l'équipement seront ajoutés au cadre de la cabine d'essayage."
...
L["If checked, you will be able to pan (right-button) and zoom (mousewheel) in the character frame, dressup frame and inspect frame.  You will be able to middle-click the character model in the character frame to toggle character attributes.  Model rotation controls will be hidden.  Buttons to toggle gear will be added to the dressup frame."] = "Se marcado, você será capaz de deslocar (botão direito) e zoom (roda do mouse) no quadro do personagem, quadro de provador e inspecionar quadro. Você será capaz de clicar com o botão do meio no modelo do personagem no quadro do personagem para alternar os atributos do personagem. Os controles de rotação do modelo serão ocultados. Botões para alternar a engrenagem serão adicionados ao quadro de provador."
...
L["If checked, your character will automatically stand or dismount when an action is prevented because you are either seated or mounted."] = "Wenn diese Option aktiviert ist, wird Ihr Charakter automatisch aufstehen oder absteigen, wenn eine Aktion verhindert wird, weil Sie entweder sitzen oder reiten."
...
L["Spooky"] = "Gruslig"
L["Stand and dismount"] = "aufstehen und absitzen"
L["Stockade"] = "Verlies"
